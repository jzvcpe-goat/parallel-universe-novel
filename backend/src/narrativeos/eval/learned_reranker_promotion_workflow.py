...
def _latest_approval_record(repository: SQLAlchemyPlatformRepository) -> Optional[Dict[str, Any]]:
    ...
    return {
        ...
        "track": payload.get("track", "reranker"),
...
def build_reranker_promotion_workflow_from_recommendation(
    *,
    ...
    if approval_status == "approved":
        recommended_action = "monitor_promoted_reranker"
    elif approval_status == "stale":
        recommended_action = "reconfirm_reranker_promotion"
    elif approval_status == "revoked":
        recommended_action = "rebuild_reranker_readiness"
    else:
...
def build_reranker_promotion_workflow_summary(
    *,
    ...
    recommendation = build_reranker_promotion_summary(
    ...
    return build_reranker_promotion_workflow_from_recommendation(
        recommendation=recommendation,
        latest_record=latest_record,
    )


def save_reranker_promotion_decision(
    *,
    repository: SQLAlchemyPlatformRepository,
    reviewer_id: str,
    reason: str,
