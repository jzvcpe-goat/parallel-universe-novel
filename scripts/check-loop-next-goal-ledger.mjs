  ...
  if (decision === 'operator_return_waiting_for_assignment') {
    return {
      ...
      requiredHumanInputs: [
        ...
        'Supabase publishable/anon key available only in local env for remote health check',
