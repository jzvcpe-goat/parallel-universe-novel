...
const components = [
  {
    ...
    openGaps: [
      'Studio canon confirmation, Reader branch publish candidate, private production branch persistence and Reader-visible release are proven locally, but remote live runtime trace is not yet proven.',
      'Production TimeEngine telemetry fitting remains a future gate.',
    ],
    nextGate: 'Add remote live runtime trace gate and reader/studio runtime facade E2E after remote Runtime is live.',
  },
  {
    id: 'world-engine',
    name: '世界引擎',
    ...
    openGaps: [
      'Reader route-choice ledger, TimeEngine consumption, branch publish candidates, authorization candidates, commit drafts, private production branch rows and Reader-visible release rows are proven.',
      'Remote public runtime facade remains disabled.',
    ],
    nextGate: 'Add remote runtime facade proof and fitted production telemetry.',
  },
  {
    id: 'genre-kernel',
    name: '类型内核',
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Reader branch publish candidate now consumes route-choice and TimeEngine candidate ledgers; P59 proves rollback; P60 proves authorization; P61 proves commit draft; P62 proves private production branch persistence; P63 proves Reader-visible public release.',
    ],
    nextGate: 'Add remote live runtime trace gate and fitted TimeEngine telemetry.',
  },
  {
