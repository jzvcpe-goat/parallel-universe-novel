...
const components = [
  ...
  },
  {
    ...
    openGaps: [
      'Deterministic Agent Eval publish decision is wired through P100, and P101 prevents optional learned dependencies from becoming release blockers; learned evaluator/reranker are still shadow-only until promotion workflow, model rollout and rollback ownership are green.',
      'Mastra upstream advisories are documented and monitored, not resolved upstream.',
    ],
    nextGate: 'Define learned evaluator/reranker promotion workflow after dependency and model rollout are stable.',
  },
  {
    id: 'codex-harness',
    name: 'Codex Harness',
