...
const components = [
  {
    ...
    openGaps: [
      ...
      'Private production branch table persistence is proven; production public branch publish and remote live runtime trace are still future gates.',
    ],
    nextGate: 'Add production public publish gate and reader/studio runtime facade E2E after remote Runtime is live.',
  },
  {
    id: 'world-engine',
    name: '世界引擎',
    ...
    openGaps: [
      'Reader route-choice ledger, TimeEngine consumption, branch publish candidates, authorization candidates, commit drafts and private production branch rows are proven, but production public branch publish is still not part of the same P45 runtime proof.',
      'Remote public runtime facade remains disabled.',
    ],
    nextGate: 'Add production public publish visibility gate and remote runtime facade proof.',
  },
  {
    id: 'genre-kernel',
    name: '类型内核',
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Reader branch publish candidate now consumes route-choice and TimeEngine candidate ledgers; P59 proves rollback; P60 proves authorization; P61 proves commit draft; P62 proves private production branch persistence; production public branch publish is still not proven.',
    ],
    nextGate: 'Add production public publish visibility gate and Reader Web branch visibility proof.',
  },
  {
