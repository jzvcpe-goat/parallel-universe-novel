...
const components = [
  {
    ...
    openGaps: [
      'Reader choice and Studio canon confirmation are not yet proven to share the same runtime run trace.',
      'Transactionality for canon/branch commit remains outside the current Creator candidate preview gate.',
    ],
  ...
  },
  {
    ...
    openGaps: [
      'WorldInstance branch memory and relationship writeback are not yet proven through the new runtime facade.',
      'Reader worldline mutation is still not part of the same P45 runtime proof.',
    ],
    nextGate: 'Add WorldInstance persistence proof for reader choices and creator confirmations.',
  },
  {
    id: 'genre-kernel',
    name: '类型内核',
  ...
  },
  {
    ...
    openGaps: [
      'Only kernel time controls and consistency reporting are proven.',
      'Non-homogeneous Poisson and Hawkes event-density simulation are not yet implemented as a durable backend engine.',
    ],
    nextGate: 'Add TimeEngine service with deterministic Poisson/Hawkes fixtures and pressure/maturity inputs.',
  },
  {
    id: 'state-writeback',
    name: '状态回写',
    ...
    openGaps: [
      'Current writeback is candidate preview only.',
      'Canon/branch commit, rollback, and transactional multi-table write are not proven in this runtime chain.',
    ],
    nextGate: 'Add canon/branch commit endpoint proof with idempotency and rollback fixtures.',
  },
  {
  ...
  },
  {
    ...
    openGaps: [
      'Candidate quality preview is proven, but full canon publishing gate is not connected to production author approval.',
      'Reader-facing live generation is not yet gated by the same quality brake.',
    ],
    nextGate: 'Add author confirmation flow where quality brake gates canon/branch commit.',
  },
  {
    id: 'agent-eval',
    name: 'Agent Eval',
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Reader choices do not yet traverse the same remote runtime facade as Creator seed-to-candidate.',
    ],
    nextGate: 'Add reader choice to runtime facade smoke after remote API/Agent deployment.',
  },
  {
    id: 'creator-studio',
    name: '创作者工作台',
