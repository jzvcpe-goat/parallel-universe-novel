...
const components = [
  {
    ...
    openGaps: [
      ...
      'Transactional multi-table canon/branch commit remains outside the current ledger-only and candidate-ledger safety proof.',
    ],
  ...
  },
  {
    ...
    openGaps: [
      'Reader route-choice ledger, TimeEngine consumption and branch publish candidates are proven, but production public branch publish is still not part of the same P45 runtime proof.',
      'Durable multi-table WorldInstance writeback and branch publish transaction rollback are not yet proven through runtime facade.',
    ],
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Production telemetry fitting and database transaction rollback fixtures remain future gates.',
    ],
    nextGate: 'Add database transaction rollback fixtures for branch publish and fitted TimeEngine consumption.',
  },
  {
    id: 'state-writeback',
    name: '状态回写',
    ...
    openGaps: [
      ...
      'Reader branch publish candidate now consumes route-choice and TimeEngine candidate ledgers, but production public branch publish and database rollback fixtures are not proven.',
    ],
