...
const components = [
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Reader branch persistence does not yet consume fitted event-density or aftershock state.',
    ],
    nextGate: 'Move TimeEngine into FastAPI runtime service and connect fitted event density to Reader branch persistence.',
  },
  {
    id: 'state-writeback',
    name: '状态回写',
    ...
    openGaps: [
      ...
      'Reader branch persistence is not yet tied to Creator run ledger or rollback fixtures.',
    ],
    nextGate: 'Add database transaction rollback and Reader branch persistence fixtures tied to the shared runtime ledger.',
  },
  {
