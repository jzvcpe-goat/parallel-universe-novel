...
const components = [
  {
    ...
    openGaps: [
      'Studio canon confirmation, Reader branch publish candidate, private production branch persistence, Reader-visible release and TimeEngine telemetry fitting are proven locally, but remote live runtime trace is not yet proven.',
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Remote live runtime trace remains a future gate.',
    ],
    nextGate: 'Add remote live runtime trace proof.',
  },
  {
    id: 'state-writeback',
    name: '状态回写',
    ...
    openGaps: [
      ...
      'Reader branch publish candidate now consumes route-choice and TimeEngine candidate ledgers; P59 proves rollback; P60 proves authorization; P61 proves commit draft; P62 proves private production branch persistence; P63 proves Reader-visible public release; P64 proves production TimeEngine telemetry fitting.',
    ],
    nextGate: 'Add remote live runtime trace gate.',
  },
  {
