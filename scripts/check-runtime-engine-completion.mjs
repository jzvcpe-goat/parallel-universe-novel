...
const components = [
  ...
  },
  {
    ...
    openGaps: [
      'Deterministic Agent Eval publish decision is wired through P100, P101 prevents optional learned dependencies from becoming release blockers, and P103 defines the learned promotion workflow; learned evaluator/reranker are still shadow-only until strict promotion execution, model rollout and rollback ownership are green.',
