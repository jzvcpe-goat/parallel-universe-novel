...
const components = [
  {
    ...
    openGaps: [
      'Studio canon confirmation is proven locally with a canon ledger trace, but public branch publish is not yet proven against the same remote runtime run trace.',
  ...
  },
  {
    ...
    openGaps: [
      'Reader route-choice ledger and WorldInstance patch candidates are proven, but public branch publish is still not part of the same P45 runtime proof.',
      'Durable multi-table WorldInstance writeback is not yet proven through runtime facade.',
    ],
    nextGate: 'Add public branch publish and durable WorldInstance transaction proof for reader choices and creator confirmations.',
  },
  {
    id: 'genre-kernel',
    name: '类型内核',
  ...
  },
  {
    ...
    openGaps: [
      'FastAPI TimeEngine persists candidate density into a rollbackable ledger, but Reader branch publish does not yet consume fitted event-density or aftershock state.',
      'Production telemetry fitting and branch-publish rollback fixtures remain future gates.',
    ],
    nextGate: 'Connect fitted TimeEngine density to Reader branch publish and add branch-publish rollback fixtures.',
  },
  {
    id: 'state-writeback',
    name: '状态回写',
    ...
    openGaps: [
      ...
      'Reader route-choice ledger and WorldInstance patch candidates now have source-run trace proof, but public branch publish and database rollback fixtures are not proven.',
    ],
