...
const components = [
  ...
  },
  {
    ...
    requiredText: [
      ...
      ['app/src/pages/Story.tsx', 'storyApi.createSession'],
      ['app/src/api/story.ts', "'/reader/sessions'"],
      ['scripts/check-reader-branch-trace.mjs', 'branch_writeback_summary'],
      ['scripts/check-reader-branch-publish.mjs', 'branch_publish_candidate_ledger_only'],
      ['scripts/check-public-branch-publish.mjs', 'reader_visible_branch_release'],
      ['scripts/browser-pages-preview-e2e.mjs', '#/library'],
      ['scripts/browser-pages-preview-e2e.mjs', 'readerToolButtons'],
    ],
    openGaps: [
  ...
  },
  {
    ...
    requiredText: [
      ...
      ['scripts/check-remote-assignment-strict-run-package.mjs', 'P118_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE'],
      ['scripts/check-remote-assignment-strict-run-package.mjs', 'remote-assignment-strict-run-package'],
      ['scripts/check-remote-assignment-strict-run-package.mjs', 'writesLocalAssignment'],
      ['scripts/check-remote-assignment-strict-run-package-artifact.mjs', 'P118_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE_ATTESTATION'],
      ['scripts/check-remote-assignment-strict-run-package-artifact.mjs', 'remote-assignment-strict-run-package'],
      ['scripts/check-remote-assignment-strict-run-package-artifact.mjs', 'remote-assignment-strict-run-package-attestation'],
      ['scripts/check-remote-assignment-strict-run-package-artifact.mjs', 'CHECK_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE_ARTIFACT_REQUIRED'],
      ['scripts/check-remote-operator-readiness-packet.mjs', 'P119_REMOTE_OPERATOR_READINESS_PACKET'],
      ['scripts/check-remote-operator-readiness-packet.mjs', 'remote-operator-readiness-packet'],
      ['scripts/check-remote-operator-readiness-packet.mjs', 'writesLocalAssignment'],
      ['scripts/check-remote-operator-readiness-packet-artifact.mjs', 'P119_REMOTE_OPERATOR_READINESS_PACKET_ATTESTATION'],
      ['scripts/check-remote-operator-readiness-packet-artifact.mjs', 'remote-operator-readiness-packet'],
      ['scripts/check-remote-operator-readiness-packet-artifact.mjs', 'remote-operator-readiness-packet-attestation'],
      ['scripts/check-remote-operator-readiness-packet-artifact.mjs', 'CHECK_REMOTE_OPERATOR_READINESS_PACKET_ARTIFACT_REQUIRED'],
      ['scripts/check-remote-operator-return-intake.mjs', 'P120_REMOTE_OPERATOR_RETURN_INTAKE'],
      ['scripts/check-remote-operator-return-intake.mjs', 'remote-operator-return-intake'],
      ['scripts/check-remote-operator-return-intake.mjs', 'writesLocalAssignment'],
      ['scripts/check-remote-operator-return-intake-artifact.mjs', 'P120_REMOTE_OPERATOR_RETURN_INTAKE_ATTESTATION'],
      ['scripts/check-remote-operator-return-intake-artifact.mjs', 'remote-operator-return-intake'],
      ['scripts/check-remote-operator-return-intake-artifact.mjs', 'remote-operator-return-intake-attestation'],
      ['scripts/check-remote-operator-return-intake-artifact.mjs', 'CHECK_REMOTE_OPERATOR_RETURN_INTAKE_ARTIFACT_REQUIRED'],
      ...
      ['scripts/check-github-actions-artifacts.mjs', 'remote-assignment-strict-run-package'],
      ...
      ['package.json', 'check:remote-assignment-strict-run-package'],
      ['package.json', 'check:remote-assignment-strict-run-package-artifact'],
      ['package.json', 'check:remote-operator-readiness-packet'],
      ['package.json', 'check:remote-operator-readiness-packet-artifact'],
      ['package.json', 'check:remote-operator-return-intake'],
      ['package.json', 'check:remote-operator-return-intake-artifact'],
      ...
      ['docs/backend/P118_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE.md', 'P118 Remote Assignment Strict-Run Package'],
      ['docs/backend/P118_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE.md', 'check:remote-assignment-strict-run-package'],
      ['docs/backend/P118_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE.md', 'check:remote-assignment-strict-run-package-artifact'],
      ['docs/backend/P119_REMOTE_OPERATOR_READINESS_PACKET.md', 'P119 Remote Operator Readiness Packet'],
      ['docs/backend/P119_REMOTE_OPERATOR_READINESS_PACKET.md', 'check:remote-operator-readiness-packet'],
      ['docs/backend/P119_REMOTE_OPERATOR_READINESS_PACKET.md', 'check:remote-operator-readiness-packet-artifact'],
      ['docs/backend/P120_REMOTE_OPERATOR_RETURN_INTAKE.md', 'P120 Remote Operator Return Intake'],
      ['docs/backend/P120_REMOTE_OPERATOR_RETURN_INTAKE.md', 'check:remote-operator-return-intake'],
      ['docs/backend/P120_REMOTE_OPERATOR_RETURN_INTAKE.md', 'check:remote-operator-return-intake-artifact'],
