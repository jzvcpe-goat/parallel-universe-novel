...
const components = [
  ...
  },
  {
    ...
    openGaps: [
      'Deterministic Agent Eval publish decision is wired through P100, but learned evaluator/reranker are still shadow-only until promotion workflow, model rollout and rollback ownership are green.',
