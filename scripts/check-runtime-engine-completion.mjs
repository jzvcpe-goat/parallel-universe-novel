...
const components = [
  {
    ...
    openGaps: [
      ...
      'Transactional multi-table canon/branch commit remains outside the current ledger-only, candidate-ledger and rollback-fixture safety proof.',
    ],
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Reader branch publish candidate now consumes route-choice and TimeEngine candidate ledgers, and P59 proves a rollback fixture, but production public branch publish is not proven.',
    ],
    nextGate: 'Add production public branch publish authorization and durable multi-table branch commit.',
  },
  {
