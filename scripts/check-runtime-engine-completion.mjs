...
const components = [
  {
    ...
    openGaps: [
      ...
      'Transactional multi-table canon/branch commit remains outside the current ledger-only, candidate-ledger, rollback-fixture and authorization-ledger safety proof.',
    ],
  ...
  },
  {
    ...
    openGaps: [
      'Reader route-choice ledger, TimeEngine consumption, branch publish candidates and authorization candidates are proven, but production public branch publish is still not part of the same P45 runtime proof.',
      'Durable multi-table WorldInstance writeback and production public branch publish are not yet proven through runtime facade.',
    ],
  ...
  },
  {
    ...
    openGaps: [
      ...
      'Reader branch publish candidate now consumes route-choice and TimeEngine candidate ledgers; P59 proves a rollback fixture; P60 proves authorization candidate; production public branch publish is still not proven.',
    ],
    nextGate: 'Add durable multi-table branch commit draft and production public publish release owner gate.',
  },
  {
