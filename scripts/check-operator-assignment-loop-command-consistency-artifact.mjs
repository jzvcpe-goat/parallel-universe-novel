...
function validateCommandConsistency(payload) {
  ...
  assert(payload.commandCount === 5, 'P130 must verify exactly five operator handoff commands')
  assert(payload.legacyFragmentCount === 2, 'P130 legacy fragment count mismatch')
