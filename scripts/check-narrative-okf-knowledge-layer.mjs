...
assert(
  String(packageJson.scripts.test || '').includes('npm run check:runtime-rule-handshake && npm run check:narrative-okf-knowledge-layer && npm run check:narrative-okf-runtime-consumption && npm run check:runtime-artifact-contract'),
