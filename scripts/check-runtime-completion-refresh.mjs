...
for (const required of [
  ...
  'P104_LEARNED_EVAL_STRICT_SUITE_READINESS',
  'learned_promotion',
  'manual_approval',
  'blocked_optional_ml_dependencies',
  'workflow_run',
  ...
  'P85_REMOTE_RUNTIME_BLOCKER_NORMALIZATION',
  'remote-runtime-blockers',
  'P87_REMOTE_ASSIGNMENT_HANDOFF',
  'P89_REMOTE_ASSIGNMENT_HANDOFF_ARTIFACT_ATTESTATION',
  'P90_REMOTE_RUNTIME_BLOCKER_ARTIFACT_ATTESTATION',
  'P91_REMOTE_ASSIGNMENT_SCHEMA_GATE',
  'P92_PUBLIC_PRIVACY_ARTIFACT_ATTESTATION',
  'P93_REMOTE_ASSIGNMENT_ARTIFACT_ATTESTATION',
  'P96_RUNTIME_COMPLETION_BLOCKER_CONVERGENCE',
  'P105_REMOTE_ASSIGNMENT_FILL_PLAN_GATE',
  'P106_REMOTE_ASSIGNMENT_FILL_PLAN_ARTIFACT_ATTESTATION',
  'P107_CI_ARTIFACT_CONTENT_COVERAGE_MATRIX',
  'P108_REMOTE_ASSIGNMENT_LOCAL_BOUNDARY_GUARD',
  'P109_GITHUB_RUNTIME_VARIABLE_BOUNDARY_GUARD',
  'P110_RUNTIME_PLACEHOLDER_SENTINEL_GUARD',
  'P116_REMOTE_ASSIGNMENT_ENV_APPLY_GATE',
  'P117_REMOTE_ASSIGNMENT_ENV_DRY_RUN_GATE',
  'P118_REMOTE_ASSIGNMENT_STRICT_RUN_PACKAGE',
  'P119_REMOTE_OPERATOR_READINESS_PACKET',
  'P120_REMOTE_OPERATOR_RETURN_INTAKE',
  'remote-assignment-artifact-attestation',
  ...
  'remote-operator-readiness-packet-attestation',
  'remote-operator-return-intake',
  'remote-operator-return-intake-attestation',
  'remote-assignment-env-apply',
  'remote-assignment-env-dry-run',
  'ci-artifact-content-coverage',
  'remote-assignment-local-boundary',
  'github-runtime-variable-boundary',
  'runtime-placeholder-sentinel',
  ...
  'confirmed Studio canon promotion database transaction proof',
  'public-projection-privacy',
  'reference-privacy',
...
for (const required of [
  ...
  'check:learned-eval-strict-suite-readiness',
  'backend/tests/test_provider_runtime_routing.py',
  'agent_eval_publish_decision',
  'P100_AGENT_EVAL_PUBLISH_DECISION_BOUNDARY',
  'P101_LEARNED_EVAL_OPTIONAL_DEPENDENCY_BOUNDARY',
  'P103_LEARNED_EVAL_PROMOTION_WORKFLOW_GATE',
  'P104_LEARNED_EVAL_STRICT_SUITE_READINESS',
...
const artifact = {
  ...
  remainingGaps: [
    'P79/P78/P76/P75/P74/P73/P66 assignment execution pack, remote activation control, live cutover, remote assignment, operator handoff, origin execution and provisioning blockers',
    'strict learned evaluator/reranker promotion execution, model rollout, rollback ownership, and team legal/access governance',
  ],
}
