...
const artifact = {
  ...
  remainingGaps: [
    ...
    'production Reader branch publish and durable multi-table WorldInstance writeback',
    'TimeEngine production telemetry fitting and database transaction rollback fixtures',
