...
const packet = {
  ...
  operatorSteps: [
    ...
    {
      order: 4,
      label: 'Diagnose Data API readiness',
      command: 'npm run check:edge-only-data-api-evidence-readiness',
      doneWhen: 'P150 separates missing Data API fields from missing health_probe evidence without printing values',
    },
    {
      order: 5,
