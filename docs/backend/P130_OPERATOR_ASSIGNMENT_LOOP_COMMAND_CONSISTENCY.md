...
hygiene, run the local readiness diagnosis, then run the edge-only compiler:
...
6. P121 generated artifacts include `check:edge-only-data-api-evidence-readiness`.
7. P121 generated artifacts include `remote-health:check`.
8. P121 generated artifacts include `prepare:edge-only-data-api-strict-intake`.
9. P121 and P123 docs/scripts use the same edge-only command sequence.
10. The old apply-env flag command is absent from P118/P121/P123/P129 docs and
   relevant checker scripts as a primary command.
11. P130 artifact remains redacted and contains no service ids, origins,
