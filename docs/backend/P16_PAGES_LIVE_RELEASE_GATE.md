...
- The `operator-operations-continuity` artifact is generated by P170 before
  upload and proves P134/P135/P136 keep-alive, local env backup and manual
  recovery rules remain attached to the operator return path.
...
31. Every Pages run must upload `operator-operations-continuity` so the release
    ...
    recovery rules are preserved as current-run evidence.
