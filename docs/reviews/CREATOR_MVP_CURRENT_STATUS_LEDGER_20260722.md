...
| `git diff --check` | Pass before R0 packaging | Whitespace hygiene only. |
| Signed-out and authenticated local Creator route QA | Pass | Compatibility routes in local Chrome. Canonical-route CI coverage remains pending. |
